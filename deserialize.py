...
def parse_Transaction(vds):
  ...
  end_pos = vds.read_cursor
  dataObj = vds.input[start_pos:end_pos]
  d['__data__'] = dataObj
  hash = hashlib.sha256(hashlib.sha256(dataObj).digest()).hexdigest()
...
opcodes = Enumeration("Opcodes", [
    ("OP_0", 0), ("OP_PUSHDATA1",76), "OP_PUSHDATA2", "OP_PUSHDATA4", "OP_1NEGATE", "OP_RESERVED", # 0, 76-80
    "OP_1", "OP_2", "OP_3", "OP_4", "OP_5", # 81-85
    "OP_6", "OP_7", "OP_8", "OP_9", "OP_10", # 86-90
    "OP_11", "OP_12", "OP_13", "OP_14", "OP_15", # 91-96
    "OP_16", "OP_NOP", "OP_VER", "OP_IF", "OP_NOTIF", # 96-100
    "OP_VERIF", "OP_VERNOTIF", "OP_ELSE", "OP_ENDIF", "OP_VERIFY", # 101-105
    "OP_RETURN", "OP_TOALTSTACK", "OP_FROMALTSTACK", "OP_2DROP", "OP_2DUP", # 106-110
    "OP_3DUP", "OP_2OVER", "OP_2ROT", "OP_2SWAP", "OP_IFDUP", # 111-115
    "OP_DEPTH", "OP_DROP", "OP_DUP", "OP_NIP", "OP_OVER", # 116-120
    "OP_PICK", "OP_ROLL", "OP_ROT", "OP_SWAP", "OP_TUCK", # 121-125
    "OP_CAT", "OP_SUBSTR", "OP_LEFT", "OP_RIGHT", "OP_SIZE", # 126-130
    "OP_INVERT", "OP_AND", "OP_OR", "OP_XOR", "OP_EQUAL", # 131-135
    "OP_EQUALVERIFY", "OP_RESERVED1", "OP_RESERVED2", "OP_1ADD", "OP_1SUB", # 136-140
    "OP_2MUL", "OP_2DIV", "OP_NEGATE", "OP_ABS", "OP_NOT", # 141-145
    "OP_0NOTEQUAL", "OP_ADD", "OP_SUB", "OP_MUL", "OP_DIV",# 146-150
    "OP_MOD", "OP_LSHIFT", "OP_RSHIFT", "OP_BOOLAND", "OP_BOOLOR",# 151-155
    "OP_NUMEQUAL", "OP_NUMEQUALVERIFY", "OP_NUMNOTEQUAL", "OP_LESSTHAN", "OP_GREATERTHAN", # 156-160
    "OP_LESSTHANOREQUAL", "OP_GREATERTHANOREQUAL", "OP_MIN", "OP_MAX", "OP_WITHIN", # 161-165
    "OP_RIPEMD160", "OP_SHA1", "OP_SHA256", "OP_HASH160", "OP_HASH256", # 166-170
    "OP_CODESEPARATOR", "OP_CHECKSIG", "OP_CHECKSIGVERIFY", "OP_CHECKMULTISIG", "OP_CHECKMULTISIGVERIFY", # 171-175
    "OP_NOP1", "OP_NOP2", "OP_NOP3", "OP_NOP4", "OP_NOP5", # 176-180
    "OP_NOP6", "OP_NOP7", "OP_NOP8", "OP_NOP9", "OP_NOP10",# 181-185
    ("OP_INVALIDOPCODE", 0xFF), # 0xFF
])
...
def extract_public_key(bytes):
  ...
  for match in multisigs:
    if match_decoded(decoded, match):
      decoded = [public_key_to_bc_address(decoded[i][1]) for i in range(1,len(decoded)-2)]
      decoded.sort()
      return "["+','.join(decoded)+"]"
  ...
  # raise Exception("extract_public_key_fail")
  return "(None)"
